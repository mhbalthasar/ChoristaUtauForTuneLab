    ...
    public class EnglishVCCVPhonemizer : SyllableBasedPhonemizer {
        ...
        protected override IG2p LoadBaseDictionary() {
            ...
            if (!File.Exists(path)) {
                ...
                ResourceManager rm = new ResourceManager("OpenUtau.Plugin.Builtin.Data.Resources", this.GetType().Assembly);
                File.WriteAllBytes(path, OpenUtauPhonemeApi.OpenUtau.Plugin.Builtin.Data.Resource.envccv_template);
            }
