...
namespace ChoristaUtauApi.UPhonemizer.OpenUtauAdapter.Builtin.Japanese
{
    ...
    [Phonemeizer("[OU]Japanese CVVC Romaji")]
    public class JapaneseCVVCPhonemizerRomaji : JapaneseCVVCPhonemizerHiragana
    {
        public JapaneseCVVCPhonemizerRomaji(VoiceBank vb) : base(vb) { }
