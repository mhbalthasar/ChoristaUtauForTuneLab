...
namespace ChoristaUtauApi.UPhonemizer.OpenUtauAdapter.Builtin.Japanese
{
    ...
    [Phonemeizer("[OU]Japanese (Presamp) Romaji")]
    public class JapanesePresampPhonemizerRomaji : JapanesePresampPhonemizerHiragana
    {
        public JapanesePresampPhonemizerRomaji(VoiceBank vb) : base(vb)
        {
        }
