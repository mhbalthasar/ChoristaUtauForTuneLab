...
#PREPARE_TEMP_DIR
TMP_DIR=/tmp/ChoristaUtau_LinuxCI_ARM64
rm -rf $TMP_DIR

#COMPILE
cd $SOLUTION_DIR
AppData=$TMP_DIR/AppData dotnet publish -r linux-arm64 -p:PlatformTarget=ARM64 -o $TMP_DIR/ExtDir ./UtauForTuneLab.sln
...
#SET DESCRIPTION
jq '.platforms = ["linux-arm64"]' $TMP_DIR/ExtDir/description.json > $TMP_DIR/AppData/TuneLab/Extensions/ChoristaUtau/description.json
...
cp $TMP_DIR/Output.tlx $SOLUTION_DIR/Output/ChoristaUtauForTuneLab_$version_linux_aarch64.tlx
